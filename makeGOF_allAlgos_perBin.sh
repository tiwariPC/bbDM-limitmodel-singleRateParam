...
for year in "2017" #"2017" "2018" #"run2"
do
   for catg in "1b" #"1b" "2b"
   do
      ...
      do
         ...
         do
            ...
            combine -M GoodnessOfFit -d $datacardws --algo=${algorithm} -n ${mode}_toy --setParametersForFit ${maskParams} --setParametersForEval ${unmaskParams} --freezeParameters r --setParameters r=0,${maskParams} -t 100 --toysFrequentist -s -1 &
            combine -M GoodnessOfFit -d $datacardws --algo=${algorithm} -n ${mode}_toy --setParametersForFit ${maskParams} --setParametersForEval ${unmaskParams} --freezeParameters r --setParameters r=0,${maskParams} -t 100 --toysFrequentist -s -1 &
            combine -M GoodnessOfFit -d $datacardws --algo=${algorithm} -n ${mode}_toy --setParametersForFit ${maskParams} --setParametersForEval ${unmaskParams} --freezeParameters r --setParameters r=0,${maskParams} -t 100 --toysFrequentist -s -1 &
            combine -M GoodnessOfFit -d $datacardws --algo=${algorithm} -n ${mode}_toy --setParametersForFit ${maskParams} --setParametersForEval ${unmaskParams} --freezeParameters r --setParameters r=0,${maskParams} -t 100 --toysFrequentist -s -1 &
            combine -M GoodnessOfFit -d $datacardws --algo=${algorithm} -n ${mode}_toy --setParametersForFit ${maskParams} --setParametersForEval ${unmaskParams} --freezeParameters r --setParameters r=0,${maskParams} -t 100 --toysFrequentist -s -1 &
