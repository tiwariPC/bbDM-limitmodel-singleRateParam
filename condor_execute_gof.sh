...
if [ $1 -eq 0 ]; then
    source /afs/cern.ch/work/p/ptiwari/cmsCombineTool/CMSSW_11_3_4/src/limitmodels/bb+DM_analysis/bbDMlimitmodelrateParam_oneRP/makeGOF_allAlgos_perBin_fromDanyer.sh
fi
