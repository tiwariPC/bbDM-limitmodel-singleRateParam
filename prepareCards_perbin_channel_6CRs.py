...
f  = open('datacard_templates/datacard_template_'+category+'_perBin_asChanel_6CRs.yaml')
...
for sigHist in getSignalHists(signalDoc,modelName):
   ...
   for ibin in ['bin1','bin2','bin3','bin4']:
      ...
      ftmp.write("wl_"+ibin+" autoMCStats 100 0 1"+"\n")
      # ftmp.write("wmu_"+ibin+" autoMCStats 100 0 1"+"\n")
      ftmp.write("topl_"+ibin+" autoMCStats 100 0 1"+"\n")
      # ftmp.write("topmu_"+ibin+" autoMCStats 100 0 1"+"\n")
      ftmp.write("zll_"+ibin+" autoMCStats 100 0 1"+"\n")
