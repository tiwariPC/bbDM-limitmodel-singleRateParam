...
# pythonFile="prepareCards_perbin_channel_6CRs.py"
for year in "16" "18" "17"
do
   # rootfile="allmethistos/AllMETHistos_v${year}_12-02-02.root"
   rootfile="allmethistos/AllMETHistos_v${year}_12-02-02_meanweight.root"

   # python ${pythonFile} -y 20${year} -c 1b -reg SR_bin1 SR_bin2 SR_bin3 SR_bin4 WL_bin1 WL_bin2 WL_bin3 WL_bin4 TOPL_bin1 TOPL_bin2 TOPL_bin3 TOPL_bin4 ZLL_bin1 ZLL_bin2 ZLL_bin3 ZLL_bin4 -f $rootfile
   # python ${pythonFile} -y 20${year} -c 2b -reg SR_bin1 SR_bin2 SR_bin3 SR_bin4 WL_bin1 WL_bin2 WL_bin3 WL_bin4 TOPL_bin1 TOPL_bin2 TOPL_bin3 TOPL_bin4 ZLL_bin1 ZLL_bin2 ZLL_bin3 ZLL_bin4 -f $rootfile

   python ${pythonFile} -y 20${year} -c 1b -reg SR_bin1 SR_bin2 SR_bin3 SR_bin4 WL_bin1 WL_bin2 WL_bin3 WL_bin4 ZLL_bin1 ZLL_bin2 ZLL_bin3 ZLL_bin4 -f $rootfile
   python ${pythonFile} -y 20${year} -c 2b -reg SR_bin1 SR_bin2 SR_bin3 SR_bin4 TOPL_bin1 TOPL_bin2 TOPL_bin3 TOPL_bin4 ZLL_bin1 ZLL_bin2 ZLL_bin3 ZLL_bin4 -f $rootfile
...
#python prepareCards.py -y 2018 -c B -reg SR TOPL TOPMU ZLL ZMUMU -f $rootfile
#python prepareCards.py -y 2018 -c R -reg SR TOPL TOPMU ZLL ZMUMU -f $rootfile
